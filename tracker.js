(function (_) {
  ...
  function g(t, e, n) {
    document.cookie = `${t}=${e}; path=/; max-age=${n}`;
  }
  function u(t) {
  ...
  function E() {
    ...
    const t = typeof navigator < "u" && navigator.doNotTrack === "1",
      ...
      n = window.JourneyWiseConsentGiven === !1;
    return !t && !e && !n;
  }
  function y() {
    let t = localStorage.getItem("jw_device_id");
    return t || ((t = _()), localStorage.setItem("jw_device_id", t)), t;
  }
  function v() {
    const t = sessionStorage.getItem("jw_campaign_origin");
    if (t) return t;
    ...
    if (
      ...
      try {
        const o = new URL(document.referrer),
          i = new URL(window.location.href);
        o.hostname !== i.hostname && (n = `referrer:${o.hostname}`);
      } catch {}
    return (
      n && sessionStorage.setItem("jw_campaign_origin", JSON.stringify(n)), n
    );
  }
  ...
  function D(t) {
    const e = {};
    for (const [n, o] of t.entries()) n.toLowerCase(), (e[n] = o);
    return e;
  }
  let m = Date.now();
  const O = h();
  ...
  function A() {
    ...
    r(a.SESSION_START, { session_id: t, timestamp: Date.now() });
  }
  function T() {
        ...
        i.addEventListener("submit", (d) => {
          ...
          if (
            !(
              c &&
              (c.formNoValidate ||
                ((I = c.hasAttribute) == null
                  ? void 0
                  : I.call(c, "formnovalidate")))
            ) &&
            !i.checkValidity()
          )
            return;
  ...
  (function () {
    var n;
    const e = ((n = window.JourneyWise) == null ? void 0 : n.q) || [];
